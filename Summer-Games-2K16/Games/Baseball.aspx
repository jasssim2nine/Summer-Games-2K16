        ...
        <div class="row">
            ...
            <div class="col-md-offset-2 col-md-8 text-center">
               ...
               <asp:GridView ID="BaseballGridView" AutoGenerateColumns="false"  CssClass="table table-bordered table-striped table-hover"
                    DataKeyNames="GAMEID" OnRowDeleting="BaseballGridView_RowDeleting" AllowPaging="true" AllowSorting="true"
                   OnSorting="BaseballGridView_Sorting" OnRowDataBound="BaseballGridView_RowDataBound"
