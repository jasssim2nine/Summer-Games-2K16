        ...
        <div class="row">
            ...
            <div class="col-md-offset-2 col-md-8 text-center">
               ...
               <asp:GridView ID="BasketballGridView" AutoGenerateColumns="false"  CssClass="table table-bordered table-striped table-hover"
                    DataKeyNames="GAMEID" OnRowDeleting="BasketballGridView_RowDeleting" AllowPaging="true" AllowSorting="true"
                   OnSorting="BasketballGridView_Sorting" OnRowDataBound="BasketballGridView_RowDataBound"
